...
(function (Carbon) {
    var Interaction = (function () {
        ...
        Interaction.prototype.onUpdate = function () {
            ...
            if (this.enableDraw) {
                if (!this.drawer)
                    this.drawer = new InteractionDrawer();
    ...
    var InteractionDrawer = (function () {
        ...
        InteractionDrawer.prototype.draw = function (interaction) {
            ...
            for (var _i = 0, _a = interaction.path; _i < _a.length; _i++) {
                var a = _a[_i];
                var value = this.getValue(a, interaction);
        ...
        InteractionDrawer.prototype.ease = function (t, b, c, d) {
            // // t: current time, b: begInnIng value, c: change In value, d: duration
            // http://www.timotheegroleau.com/Flash/experiments/easing_function_generator.htm
            var tc = (t /= d) * t * t;
            return b + c * (tc);
        };
        InteractionDrawer.prototype.getValue = function (point, interaction) {
            var value = point[2] / interaction.elapsed;
